        ...
        <div className="container mx-auto">
            ...
            <table className="table-auto max-w-lg mx-auto mt-5">
                ...
                <tbody>
                    {receipt.map((user) => (
                            <tr key={user._id}>
                                <td className="border text-center px-4 py-2">{user.receiptNumber}</td>
                                ...
                                <td className="border text-center px-4 py-2">{user.receiptDate}</td>
                                <td className="border text-center px-4 py-2">{user.invoiceNumber}</td>
                                <td className="border text-center px-4 py-2">{user.paymentype}</td>
                                <td className="border font-semibold text-center px-4 py-2">{user.totalAmount}</td>
                                <td className="border text-green-600 font-semibold text-center px-4 py-2">{user.lastPaidAmount}</td>
                                <td className="border text-red-600 font-semibold text-center px-4 py-2">{user.pendingAmount}</td>
                                <td>
